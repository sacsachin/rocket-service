...
type RocketServiceClient interface {
	...
	AddRocket(ctx context.Context, in *AddRockerRequest, opts ...grpc.CallOption) (*AddRockerResponse, error)
...
func (c *rocketServiceClient) AddRocket(ctx context.Context, in *AddRockerRequest, opts ...grpc.CallOption) (*AddRockerResponse, error) {
	out := new(AddRockerResponse)
...
type RocketServiceServer interface {
	...
	AddRocket(context.Context, *AddRockerRequest) (*AddRockerResponse, error)
...
func (UnimplementedRocketServiceServer) AddRocket(context.Context, *AddRockerRequest) (*AddRockerResponse, error) {
...
func _RocketService_AddRocket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RocketServiceServer).AddRocket(ctx, req.(*AddRockerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
